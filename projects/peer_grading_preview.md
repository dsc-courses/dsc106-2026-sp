---
layout: page
title: 'Peer Grading Preview'
parent: '📝 Projects'
nav_order: 8
---

# Peer Grading Preview

This preview shows how peer grading adjustments are calculated from team-member ratings.
...
<div id="peer-grading-tool" class="peer-grading-preview">
  <template id="rating-template">
    <select class="rating-select" aria-label="Peer rating">
  ...
  <div class="peer-grading-controls">
  ...
  <div class="peer-grading-table-wrap">
    <table class="peer-grading-table">
      <thead>
        <tr>
          <th scope="col"></th>
...
<style>
  ...
  .peer-grading-controls {
    margin-bottom: 1rem;
  }

  .peer-grading-preview .team-size-control {
    display: inline-flex;
    align-items: center;
    gap: 0.5rem;
  ...
  .peer-grading-preview .team-size-control legend {
    padding: 0;
  }

  .peer-grading-preview .team-size-control label {
    display: inline-flex;
    align-items: center;
    gap: 0.25rem;
  }

  .peer-grading-preview .rating-legend {
    margin: 0;
  }

  .peer-grading-preview select {
    max-width: 100%;
  }

  .peer-grading-preview .rating-select {
    min-width: 3.35rem;
  }

  .peer-grading-table-wrap {
    overflow-x: auto;
  }

  .peer-grading-table-wrap .table-wrapper {
    min-width: 0;
  }
  ...
  .peer-grading-table th,
  .peer-grading-table td {
...
<script>
  (function () {
    const maxTeamSize = 4;
    const preview = document.getElementById("peer-grading-tool");
